# Copied shamelessly from https://github.com/OpenSystemsLab/base32.nim/blob/master/base32.nim
# Rev 3e1abe8dcdf801c0e112674502cfcbe6593fc4e4
#
...
proc encode*[T: byte | char | uint8](s: openArray[T]; pad=true): string =
...
proc decode*[T: char | uint8 | byte](s: openArray[T]): string =
